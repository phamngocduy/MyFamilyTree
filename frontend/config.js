...
async function importVueJS() {
    return await import('./node_modules/vue/dist/vue.esm-browser.prod.js');
}

const backendURL = 'https://exbaalvricmyyuytalf3zykjcy0yxwet.lambda-url.ap-southeast-1.on.aws';
